...
RSpec.describe Unit::Types::BeneficialOwner do
  ...
  describe 'validation' do
    it 'raises error if both SSN and passport are provided' do
      ...
      }.to raise_error(ArgumentError, 'BeneficialOwner requires either SSN or passport, but not both')
    end
    ...
    it 'raises error if neither SSN nor passport is provided' do
      ...
      }.to raise_error(ArgumentError, 'BeneficialOwner requires either SSN or passport')
    end
    ...
    it 'raises error if passport is provided without nationality' do
      ...
      }.to raise_error(ArgumentError, 'BeneficialOwner requires nationality when passport is provided')
    end
